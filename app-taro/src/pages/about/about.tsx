...
export default function About() {
  ...
  return (
    <View
      ...
      style={{ paddingTop: `calc(${statusBarHeight}px + 160rpx + 32rpx)` }}
    >
      ...
      <View className="about-content">
        <View className="logo-section">
          <Image
            ...
            mode="aspectFit"
          />
          <Text className="app-name">PillPal</Text>
        ...
        <View className="info-section">
          <View className="info-item">
            ...
            <Text className="info-value">PillPal</Text>
          </View>
          <View className="info-item">
        ...
        <View className="copyright-section">
          <Text className="copyright-text">2026 PillPal 保留权利</Text>
        </View>
      </View>
    </View>
  );
