...
function TraceConfirm() {
  ...
  var onAddImage = function onAddImage() {
    ...
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().chooseImage({
      ...
      success: function success(res) {
        setImagePaths([].concat((0,F_medimate_app_taro_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(imagePaths), (0,F_medimate_app_taro_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(res.tempFilePaths)));
      },
      fail: function fail() {
        _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
          title: '选择图片失败',
