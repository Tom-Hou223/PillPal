(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([[277],{
...
/* harmony export */   A: function() { return /* binding */ ReminderSettings; }
/* harmony export */ });
...
/* harmony import */ var _services_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4746);
...
function ReminderSettings() {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    ...
    reminderSettings = _useState4[0],
    setReminderSettings = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    expirySubscribed = _useState6[0],
    setExpirySubscribed = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    medicationSubscribed = _useState8[0],
    setMedicationSubscribed = _useState8[1];
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('提前15分钟'),
    ...
    reminderTimeLabel = _useState14[0],
    setReminderTimeLabel = _useState14[1];
  ...
  var updateLabels = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (time, days) {
    var timeItem = REMINDER_TIMES.find(function (t) {
      return t.value === time;
    });
    var dayItem = EXPIRY_WARNING_DAYS.find(function (d) {
      return d.value === days;
    });
  ...
  var loadSettings = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    ...
    var reminderTime = savedSettings.reminderTime || 15;
    var expiryWarningDays = savedSettings.expiryWarningDays || 30;
    setReminderSettings({
    ...
    // 如果已登录，从服务器加载设置
    if (isLoggedIn) {
      _services_api__WEBPACK_IMPORTED_MODULE_4__/* .notificationsApi */ .vx.getSettings().then(function (res) {
        if (res.code === 0) {
  ...
  var loadSubscriptions = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    if (!isLoggedIn) return;
    _services_api__WEBPACK_IMPORTED_MODULE_4__/* .notificationsApi */ .vx.getSubscriptions().then(function (res) {
      if (res.code === 0) {
        var subscriptions = res.data.subscriptions || [];
        setExpirySubscribed(subscriptions.some(function (s) {
          return s.template_type === 'expiry' && s.is_active;
        }));
        setMedicationSubscribed(subscriptions.some(function (s) {
          return s.template_type === 'medication' && s.is_active;
        }));
  ...
  var onSave = function onSave() {
    ...
    if (isLoggedIn) {
      _services_api__WEBPACK_IMPORTED_MODULE_4__/* .notificationsApi */ .vx.saveSettings({
  ...
  var onClearHistory = function onClearHistory() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: '清除通知历史',
      ...
      success: function success(res) {
        if (res.confirm) {
          var storage = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageInfoSync();
  ...
  var onSubscribeExpiry = function onSubscribeExpiry() {
    if (!isLoggedIn) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
        title: '请先登录',
        icon: 'none'
    ...
    var templateId = templates.expiry || 'pYTIFUgvO40l0ZnQ3Miy6P5x_VpYUF5GY_NuuvkxeLE';
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().requestSubscribeMessage({
      tmplIds: [templateId],
      success: function success(res) {
        if (res[templateId] === 'accept') {
          _services_api__WEBPACK_IMPORTED_MODULE_4__/* .notificationsApi */ .vx.subscribe('expiry').then(function () {
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
              title: '订阅成功',
              icon: 'success'
            });
      ...
      fail: function fail(err) {
        if ((err === null || err === void 0 ? void 0 : err.errCode) === 20001) {
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
  ...
  var onSubscribeMedication = function onSubscribeMedication() {
    if (!isLoggedIn) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
        title: '请先登录',
        icon: 'none'
    ...
    var templateId = templates.medication || 'S07bmEbAECl0mAdvmz4RRFsUh8sDLvVOTtvLx7vyL7A';
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().requestSubscribeMessage({
      tmplIds: [templateId],
      success: function success(res) {
        if (res[templateId] === 'accept') {
          _services_api__WEBPACK_IMPORTED_MODULE_4__/* .notificationsApi */ .vx.subscribe('medication').then(function () {
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
              title: '订阅成功',
              icon: 'success'
            });
  ...
  var renderSheet = function renderSheet(show, title, options, currentValue, onSelect, onClose) {
    if (!show) return null;
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
      className: "sheet-overlay",
      onClick: onClose,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "sheet-title",
            children: title
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          children: options.map(function (item) {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                ...
                children: item.label
              }), currentValue === item.value && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_nav_bar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A, {
      title: "\u63D0\u9192\u8BBE\u7F6E",
      showBack: true
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
      className: "content",
      style: {
        paddingTop: "calc(".concat(statusBarHeight, "px + 88rpx + 24rpx)")
      },
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "section",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              children: "\u5F00\u542F\u63D0\u9192"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Switch */ .dO, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                ...
                children: reminderTimeLabel
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
      ...
      }), isLoggedIn && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "section",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "section-title",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              className: "cell-value-wrap",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "subscription-tag ".concat(expirySubscribed ? 'subscribed' : ''),
                children: expirySubscribed ? '已订阅' : '未订阅'
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "cell-arrow",
                children: ">"
              })]
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              className: "cell-value-wrap",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "subscription-tag ".concat(medicationSubscribed ? 'subscribed' : ''),
                children: medicationSubscribed ? '已订阅' : '未订阅'
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "cell-arrow",
                children: ">"
              })]
    ...
    }), renderSheet(showReminderTimeSheet, '选择提醒时间', REMINDER_TIMES, reminderSettings.reminderTime, function (value) {
      setReminderSettings(function (s) {
        return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)((0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)({}, s), {}, {
          reminderTime: value
        });
    ...
    }), renderSheet(showExpiryWarningSheet, '选择预警天数', EXPIRY_WARNING_DAYS, reminderSettings.expiryWarningDays, function (value) {
      setReminderSettings(function (s) {
        return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)((0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)({}, s), {}, {
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_reminder_settings_reminder_settings_reminder_settings_tsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7169);


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_1__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_reminder_settings_reminder_settings_reminder_settings_tsx__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A, 'pages/reminder-settings/reminder-settings', {root:{cn:[]}}, config || {}))
...
/******/ var __webpack_exports__ = (__webpack_exec__(6223));
/******/ }
]);