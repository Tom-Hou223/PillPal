(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([[347],{
...
/* harmony export */   A: function() { return /* binding */ Backup; }
/* harmony export */ });
...
function Backup() {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    backupHistory = _useState6[0],
    setBackupHistory = _useState6[1];
  ...
  var loadBackupHistory = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    var history = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync('backupHistory') || [];
  ...
  var onBackupNow = /*#__PURE__*/function () {
    var _ref = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(/*#__PURE__*/(0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)().m(function _callee() {
      var familyId, _yield$Promise$all, _yield$Promise$all2, medicinesRes, plansRes, membersRes, backupData, history, _t;
      return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            return _context.a(2);
          case 1:
            familyId = _services_api__WEBPACK_IMPORTED_MODULE_4__/* .FamilyManager */ .kT.getCurrentFamilyId();
            if (familyId) {
              _context.n = 2;
              break;
            }
          ...
          case 2:
            ...
            _context.p = 3;
            _context.n = 4;
            return Promise.all([_services_api__WEBPACK_IMPORTED_MODULE_4__/* .medicineApi */ .f0.getList(), _services_api__WEBPACK_IMPORTED_MODULE_4__/* .planApi */ .uD.getList(), _services_api__WEBPACK_IMPORTED_MODULE_4__/* .familyApi */ .Ds.getList()]);
          case 4:
            _yield$Promise$all = _context.v;
            _yield$Promise$all2 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(_yield$Promise$all, 3);
            medicinesRes = _yield$Promise$all2[0];
            plansRes = _yield$Promise$all2[1];
            membersRes = _yield$Promise$all2[2];
            backupData = {
            ...
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('backupData', backupData);

            // 更新备份历史
            history = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync('backupHistory') || [];
            history.unshift({
            ...
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('backupHistory', history);
            setBackupHistory(history);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
              title: '备份成功',
              icon: 'success'
    ...
    return function onBackupNow() {
      return _ref.apply(this, arguments);
    };
  }();
  var onRestoreData = function onRestoreData() {
    if (isGuestMode) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
        title: '登录提示',
        content: '需要登录才能恢复数据',
  ...
  var performRestore = function performRestore() {
    var backupData = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync('backupData');
    if (!backupData) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
        title: '无备份数据',
        icon: 'none'
  ...
  var onExportData = /*#__PURE__*/function () {
    var _ref2 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(/*#__PURE__*/(0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)().m(function _callee2() {
      var familyId, _yield$Promise$all3, _yield$Promise$all4, medicinesRes, plansRes, membersRes, exportData, _t2;
      return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 4:
            ...
            _yield$Promise$all4 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(_yield$Promise$all3, 3);
            medicinesRes = _yield$Promise$all4[0];
            plansRes = _yield$Promise$all4[1];
            membersRes = _yield$Promise$all4[2];
            exportData = {
              timestamp: new Date().getTime(),
              date: new Date().toISOString(),
              version: '1.0',
            ...
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('exportData', exportData);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
              title: '导出成功',
              icon: 'success'
            });
  ...
  var performImport = function performImport() {
    var importData = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync('exportData');
    if (!importData) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
        title: '无导入数据',
        icon: 'none'
  ...
  var onClearBackup = function onClearBackup() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: '确认清除',
      ...
      success: function success(res) {
        if (res.confirm) {
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().removeStorageSync('backupData');
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().removeStorageSync('backupHistory');
          setBackupHistory([]);
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
            title: '已清除',
            icon: 'success'
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_nav_bar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
            className: "backup-card ".concat(loading ? 'disabled' : ''),
            onClick: loading ? undefined : onBackupNow,
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              className: "backup-card-icon",
              children: "\uD83D\uDCBE"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              className: "backup-card-title",
              children: "\u7ACB\u5373\u5907\u4EFD"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              className: "backup-card-desc",
              children: "\u5907\u4EFD\u5F53\u524D\u836F\u54C1\u3001\u8BA1\u5212\u548C\u5BB6\u5EAD\u6210\u5458\u6570\u636E"
            })]
          })
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
          ...
          }), backupHistory.length > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
            className: "clear-btn",
          ...
          children: backupHistory.map(function (item, index) {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                    className: "history-stat",
                    children: ["\u836F\u54C1 ", item.medicines]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                    className: "history-divider",
                    children: "|"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                    className: "history-stat",
                    children: ["\u8BA1\u5212 ", item.plans]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                    className: "history-divider",
                    children: "|"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
                    className: "history-stat",
                    children: ["\u6210\u5458 ", item.members]
                  })]
                })]
              })
            }, index);
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .Text */ .EY, {
              ...
              className: "data-card-desc",
              children: "\u5BFC\u51FA\u4E3A JSON \u683C\u5F0F"
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
            className: "data-card",
      ...
      }), loading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_9__/* .View */ .Ss, {
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_backup_backup_backup_tsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9409);


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_1__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_backup_backup_backup_tsx__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A, 'pages/backup/backup', {root:{cn:[]}}, config || {}))
...
/******/ var __webpack_exports__ = (__webpack_exec__(4433));
/******/ }
]);