(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([[931],{
...
/* harmony export */   A: function() { return /* binding */ Export; }
/* harmony export */ });
...
function Export() {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('medicine'),
    ...
    exportType = _useState6[0],
    setExportType = _useState6[1];
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    showStartPicker = _useState0[0],
    setShowStartPicker = _useState0[1];
  var _useState1 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    showEndPicker = _useState10[0],
    setShowEndPicker = _useState10[1];
  ...
  // 辅助函数
  var getMedicineStatusText = function getMedicineStatusText(status) {
    switch (status) {
      case 'normal':
        return '正常';
      case 'warning':
  ...
  var getRecordStatusText = function getRecordStatusText(status) {
    switch (status) {
      case 'completed':
        return '已完成';
      case 'missed':
  ...
  var generateMedicineCSV = function generateMedicineCSV(medicines) {
    var csv = '药品名称,生产厂家,规格,用量,库存,单位,过期日期,类别,状态,备注\n';
    medicines.forEach(function (m) {
      var row = [m.name || '', m.manufacturer || '', m.specification || '', m.dosage || '', m.stock || 0, m.unit || '', m.expiryDate || '', m.category || '', getMedicineStatusText(m.status), m.note || ''];
      csv += row.map(function (item) {
        return "\"".concat(item, "\"");
      }).join(',') + '\n';
    });
    return csv;
  };
  var generatePlanCSV = function generatePlanCSV(plans) {
    var csv = '药品名称,家庭成员,频率,开始日期,结束日期,状态,备注\n';
    plans.forEach(function (p) {
      var row = [p.medicineName || '', p.memberName || '', p.frequency || '', p.startDate || '', p.endDate || '', p.status === 'active' ? '进行中' : '已结束', p.note || ''];
      csv += row.map(function (item) {
        return "\"".concat(item, "\"");
      }).join(',') + '\n';
    });
  ...
  var generateRecordCSV = function generateRecordCSV(records) {
    var csv = '药品名称,家庭成员,时间,日期,状态,备注\n';
    records.forEach(function (r) {
      var row = [r.medicineName || '', r.memberName || '', r.time || '', r.date || '', getRecordStatusText(r.status), r.supplement || ''];
      csv += row.map(function (item) {
        return "\"".concat(item, "\"");
      }).join(',') + '\n';
    });
  ...
  var showResultModal = function showResultModal(fileName, csvData) {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: '导出成功',
      content: "\u6587\u4EF6 ".concat(fileName, " \u5DF2\u751F\u6210\uFF0C\u5171 ").concat(csvData.split('\n').length - 2, " \u6761\u8BB0\u5F55"),
      showCancel: false
    });
  };
  var onExport = /*#__PURE__*/function () {
    var _ref = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(/*#__PURE__*/(0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)().m(function _callee() {
      var res, csvData, _res, _csvData, _res2, _csvData2, _t, _t2;
      return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            _context.p = 1;
            _t = exportType;
            _context.n = _t === 'medicine' ? 2 : _t === 'plan' ? 6 : _t === 'record' ? 10 : 15;
            break;
          case 2:
            _context.n = 3;
          ...
          case 3:
            ...
            csvData = generateMedicineCSV(res.data);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('exportData_medicine', csvData);
          ...
          case 7:
            ...
            _csvData = generatePlanCSV(_res.data);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('exportData_plan', _csvData);
            showResultModal('用药计划.csv', _csvData);
            _context.n = 9;
            break;
          case 8:
          ...
          case 11:
            _context.n = 12;
            return _services_api__WEBPACK_IMPORTED_MODULE_3__/* .recordsApi */ .Jp.getList();
          case 12:
            _res2 = _context.v;
            if (!(_res2.code === 0)) {
              _context.n = 13;
            ...
            _csvData2 = generateRecordCSV(_res2.data);
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync('exportData_record', _csvData2);
            showResultModal("\u7528\u836F\u8BB0\u5F55_".concat(dateRange.start, "_").concat(dateRange.end, ".csv"), _csvData2);
            _context.n = 14;
            break;
          case 13:
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_components_nav_bar__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A, {
      title: "\u6570\u636E\u5BFC\u51FA",
      showBack: true
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
      className: "content",
      style: {
        paddingTop: "calc(".concat(statusBarHeight, "px + 88rpx + 24rpx)")
      },
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "section",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "section-title",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            children: "\u5BFC\u51FA\u7C7B\u578B"
          })
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "custom-tabs",
          children: exportTypes.map(function (item) {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
              className: "custom-tab-item ".concat(exportType === item.name ? 'active' : ''),
              onClick: function onClick() {
                return setExportType(item.name);
              },
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "custom-tab-text ".concat(exportType === item.name ? 'active' : ''),
                children: item.title
              }), exportType === item.name && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
                className: "tab-underline"
              })]
            }, item.name);
          })
        })]
      }), exportType === 'record' && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "section",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "section-title",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "date-text ".concat(dateRange.start ? '' : 'placeholder'),
                children: dateRange.start || '请选择开始日期'
              })
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            className: "date-item",
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              className: "date-picker-value",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "date-text ".concat(dateRange.end ? '' : 'placeholder'),
                children: dateRange.end || '请选择结束日期'
              })
            })]
          })]
        })]
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "info-dot",
                children: "\u2022"
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                className: "info-text",
                children: "\u6570\u636E\u5C06\u4EE5 CSV \u683C\u5F0F\u5BFC\u51FA"
              })]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
              className: "info-item",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          onClick: loading ? undefined : onExport,
          children: loading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
      ...
      }), showStartPicker && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "sheet-overlay",
        onClick: function onClick() {
          return setShowStartPicker(false);
        },
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("picker", {
              ...
              onChange: function onChange(e) {
                setDateRange(function (r) {
                  return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A)((0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A)({}, r), {}, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
                  children: dateRange.start || '请选择日期'
                })
              })
            })
          })]
        })
      }), showEndPicker && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "sheet-overlay",
        onClick: function onClick() {
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_export_export_export_tsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9613);


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_1__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_export_export_export_tsx__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A, 'pages/export/export', {root:{cn:[]}}, config || {}))
...
/******/ var __webpack_exports__ = (__webpack_exec__(7405));
/******/ }
]);