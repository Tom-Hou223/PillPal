(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([[817],{
...
var Login = function Login() {
  var _useUserStore = (0,_stores_user_store__WEBPACK_IMPORTED_MODULE_3__/* .useUserStore */ .k)(),
    ...
    setLoggedIn = _useUserStore.setLoggedIn,
    setCurrentFamily = _useUserStore.setCurrentFamily;
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("phone"),
  ...
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    ...
    nicknameError = _useState16[0],
    setNicknameError = _useState16[1];
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    _useState18 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(_useState17, 2),
    passwordError = _useState18[0],
    setPasswordError = _useState18[1];
  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState20 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(_useState19, 2),
    statusBarHeight = _useState20[0],
    setStatusBarHeight = _useState20[1];
  ...
  var checkLoginStatus = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    if (isLoggedIn) {
  ...
  var loadRememberedCredentials = function loadRememberedCredentials() {
    var remembered = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync("rememberedCredentials");
    if (remembered) {
  ...
  var validateNickname = function validateNickname(value) {
    if (!value || value.trim() === "") {
      setNicknameError("");
      return false;
    }
  ...
  var onPhoneInput = function onPhoneInput(e) {
    var _ref, _e$detail$value;
    var val = String((_ref = (_e$detail$value = e.detail.value) !== null && _e$detail$value !== void 0 ? _e$detail$value : e.detail) !== null && _ref !== void 0 ? _ref : "");
    setPhone(val);
    validatePhone(val);
  };
  var onNicknameInput = function onNicknameInput(e) {
  ...
  var handleLoginSuccess = function handleLoginSuccess(loginData) {
    setLoading(false);
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().hideLoading();

    // Save remembered credentials
    if (rememberMe) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().setStorageSync("rememberedCredentials", {
        phone: activeTab === "phone" ? phone.trim() : "",
        password: password
      });
    } else {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().removeStorageSync("rememberedCredentials");
    }
    ...
    var currentFamily = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync("currentFamily");
    var hasFamilies = loginData.hasFamily && loginData.families && loginData.families.length > 0;
    setTimeout(function () {
  ...
  var handleLoginError = function handleLoginError(error) {
    setLoading(false);
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().hideLoading();
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showToast({
  ...
  var onLogin = function onLogin() {
    ...
    var loginPromise = activeTab === "phone" ? _services_api__WEBPACK_IMPORTED_MODULE_2__/* .authApi */ .ZQ.loginByPhone(phone.trim(), password) : _services_api__WEBPACK_IMPORTED_MODULE_2__/* .authApi */ .ZQ.loginByNickname(nickname.trim(), password);
  ...
  // WeChat login
  var onWeChatLogin = /*#__PURE__*/function () {
    var _ref2 = (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(/*#__PURE__*/(0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)().m(function _callee() {
      var loginRes, res, loginData, currentFamily, hasFamilies, _t;
      return (0,D_PillPal_app_taro_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 2:
            loginRes = _context.v;
            _context.n = 3;
            return _services_api__WEBPACK_IMPORTED_MODULE_2__/* .authApi */ .ZQ.wxLogin(loginRes.code);
          case 3:
            res = _context.v;
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().hideLoading();
            if (res.code === 0) {
              ...
              currentFamily = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().getStorageSync("currentFamily");
              hasFamilies = loginData.hasFamily && loginData.families && loginData.families.length > 0;
              setTimeout(function () {
                if (!currentFamily || !currentFamily.id) {
                  if (hasFamilies) {
                    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().redirectTo({
    ...
    return function onWeChatLogin() {
      return _ref2.apply(this, arguments);
    };
  }();

  // Guest mode
  var onGuestLogin = function onGuestLogin() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: "提示",
      ...
      success: function success(res) {
        if (res.confirm) {
          _stores_user_store__WEBPACK_IMPORTED_MODULE_3__/* .useUserStore */ .k.getState().setGuestMode();
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().switchTab({
            url: "/pages/index/index"
          });
        }
  ...
  var onRememberChange = function onRememberChange(e) {
    setRememberMe(!!e.detail.value);
  };
  var togglePassword = function togglePassword() {
    setShowPassword(!showPassword);
  };
  var showUserAgreement = function showUserAgreement() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: "用户协议",
      content: "欢迎使用PillPal！本协议是您与PillPal之间的法律协议。请您务必审慎阅读、充分理解本协议各条款内容...",
      showCancel: true,
      confirmText: "同意",
      cancelText: "取消"
    });
  };
  var showPrivacyPolicy = function showPrivacyPolicy() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().showModal({
      title: "隐私政策",
      content: "PillPal致力于保护您的隐私。本政策描述了我们如何收集、使用、存储和保护您的个人信息...",
      showCancel: true,
      confirmText: "同意",
      cancelText: "取消"
    });
  };
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
    className: "login-container",
    style: {
      paddingTop: "calc(".concat(statusBarHeight, "px + 80rpx)")
    },
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "tab ".concat(activeTab === "phone" ? "active" : ""),
          style: activeTab === "phone" ? {
            color: "#27AE60",
            borderBottom: "2rpx solid #27AE60"
          } : {},
          onClick: function onClick() {
            return switchTab("phone");
          },
          children: "\u624B\u673A\u53F7\u767B\u5F55"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "tab ".concat(activeTab === "account" ? "active" : ""),
        ...
        children: [activeTab === "phone" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
              ...
              children: "\uD83D\uDCF1"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Input */ .pd, {
          ...
          }), phoneError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "error-message",
            children: phoneError
          })]
        }), activeTab === "account" && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
          className: "form-group",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            className: "field-wrapper",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          ...
          }), nicknameError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "error-message",
          ...
          }), passwordError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "error-message",
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Checkbox */ .Sc, {
              checked: rememberMe,
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$n, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$n, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          ...
          className: "guest-desc",
          children: "\u65E0\u9700\u767B\u5F55\uFF0C\u6D4F\u89C8\u793A\u4F8B\u6570\u636E"
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .View */ .Ss, {
        className: "footer",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
          children: ["\u767B\u5F55\u5373\u8868\u793A\u540C\u610F", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "link",
            onClick: showUserAgreement,
            children: "\u300A\u7528\u6237\u534F\u8BAE\u300B"
          }), "\u548C", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_8__/* .Text */ .EY, {
            className: "link",
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_login_login_login_tsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1649);


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_1__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pages_login_login_login_tsx__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A, 'pages/login/login', {root:{cn:[]}}, config || {}))
...
/******/ var __webpack_exports__ = (__webpack_exec__(1411));
/******/ }
]);